...
<body>
  ...
  <div class="jumbotron text-center bg-light">
    <h1 class="display-4 animated slideInLeft delay-1s">A cada 100 pessoas no Brasil,
       quantas delas estão desocupadas?</h1><br><br>
      <?php
      $tot = 0;
      for ($j=0;$j<5;$j++){
        for ($i=0; $i<20; $i++){
    ...
    <div class="row">
      ...
      style='display:none;' href="jobs.php">E o rendimento?</a>
      </div>
    </div>
    ...
    // adds answer text
      ...
      text += (value).toString();
      text += "% da população brasileira não tem emprego";
      ptag.innerHTML = text;
      await sleep(3000);
      ...
      lista[i].addEventListener('click',function(e){
        ...
        $.ajax({
            ...
            success: function(data){
                graph_answer(pct,data['taxaDesocupacao'],show_answer);
